...
#ifndef FILTER_DUMP__
#define FILTER_DUMP__
...
class CDumpInputPin : public CRenderedInputPin
{
    ...
    REFERENCE_TIME m_tLastDuration;
    LONG            m_LastDataLength;
    bool            m_bFoundStrangeCase;

    void StrangeCaseFound();
...
public:
    ...
    LPOLESTR getFileName() { return m_pFileName; }
