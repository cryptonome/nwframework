...
#pragma warning(disable:4312) // warning C4312: 'type cast' : conversion from 'LONG' to 'CBasePropertyPage *' of greater size
#pragma warning(disable:4244) // warning C4244: 'argument' : conversion from 'LPARAM' to 'LONG', possible loss of data
