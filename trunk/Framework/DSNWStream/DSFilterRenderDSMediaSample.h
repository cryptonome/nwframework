 ...
 */
#ifndef DSFILTERRENDERDSMEDIASAMPLE_H_
#define DSFILTERRENDERDSMEDIASAMPLE_H_
...
//
//********************************************************************
class DSFilterRenderStreamDSMediaSample : public CBaseRenderer
{
public:

    static DSFilterRenderStreamDSMediaSample* createInstance(INWStreamWriter* _stream);

    DECLARE_IUNKNOWN

private:
    DSFilterRenderStreamDSMediaSample  (HRESULT* phr, INWStreamWriter* _stream);
    virtual    ~DSFilterRenderStreamDSMediaSample ();
