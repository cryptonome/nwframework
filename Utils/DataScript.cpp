...
/*#ifdef VISUALSTUDIO // TODO
*/
std::string Utf8ToAnsiAux(const char* pszText) { return std::string(); }
std::string AnsiToUtf8Aux(const char* pszText) { return std::string(); }
/*#else
std::string Utf8ToAnsiAux(const char* pszText) { return Utf8ToAnsi(pszText).c_str(); }
std::string AnsiToUtf8Aux(const char* pszText) { return AnsiToUtf8(pszText).c_str(); }
#endif*/
...
{
    std::string ansiStr = AnsiToUtf8Aux(_str);
